...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/arrive/img/pages/'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/arrive/webroot/img/pages/'; // Physical path. [Usually works fine like this]
