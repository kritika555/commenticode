<div id="loginInfo" class="col-md-4 col-md-offset-3 col-xs-12 col-sm-8 login-box">
    <div class="titleHeading">Reset Password</div>
    <div class="listedData">
        <table class="login_form">
           ...
           ?>
            ...
            <tr>
                <td colspan="2" class="head">
                    <?php echo $this->Form->input('confirm_password', array( 'type'=> 'password', 'required' => 'true')); ?>
                </td>
            </tr>
            <tr>
                <td colspan="2"><label>&nbsp;</label>
                    <?php
                    echo $this->Form->button('Submit', array('type' => 'submit', 'escape' => true, "class" => "btn btn-success"));
