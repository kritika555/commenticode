...
<div class="pages form col-xs-12 content">
    <?= $this->Form->create($backlog, ['enctype'=>'multipart/form-data', 'id'=>'backlog-form']) ?>
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('start_date', ['type'=>'date', 'class'=>'datepicker', 'readonly'=>'readonly']);
            echo $this->Form->input('end_date', ['type'=>'date', 'class'=>'datepicker', 'readonly'=>'readonly']);
            echo $this->Form->input('vote_start_date', ['label'=>'Voting Start Date', 'type'=>'text', 'class'=>'datepicker', 'readonly'=>'readonly']);
            echo $this->Form->input('vote_end_date', ['label'=>'Voting End Date', 'type'=>'text', 'class'=>'datepicker', 'readonly'=>'readonly']);
